...
\section{Publications}
\runsubsection{Genorch - A tool for large-scale, cloud vendor neutral deployments}
    \descript{|  NETSOFT 2018}
    This paper is still in progress and is supposed to describe what we have
    done in Genorch Project (more detail in the project section) to tackle
    with the problem of large-scale and multi-cloud deployments.
