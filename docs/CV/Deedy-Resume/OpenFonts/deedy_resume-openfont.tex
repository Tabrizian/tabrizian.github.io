...
\runsubsection{NovinNet}
    \descript{| PHP}
    NovinNet is a platform for managing 250 welding controllers at IKCO -
    leading car company in Iran. It uses redis as a job queue and laravel
    to provide the web interface for users to manage it.
\sectionsep
