...
\href{mailto:iman.tabrizian@mail.utoronto.ca}{iman.tabrizian@mail.utoronto.ca} | +1 (647) 551-9065 }
...
\descript{MASc in Electrical and Computer Engineering}
    \location{2019 - 2020 (Expected) | Toronto, CA}
...
\item Selected to Participate in \\
	Facebook PyTorch Scholarship (2019)
...
\section{Teaching}
    \vspace{\topsep} % Hacky fix for awkward extra vertical space
\begin{tightemize}
\item Teaching assistant Web Programming Course (CSC309)
\item Teaching assistant Database Course 
\item Teaching assistant Introduction to Programming with C
\item Teaching assistant Advanced Programming with Java 
